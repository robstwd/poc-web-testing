Feature: ADHA FHIR IG landing page
  ...
  Scenario: Body of landing page - link one
    ...
    And when body link 1 is clicked, it resolves to "https://fhir.digitalhealth.gov.au/dh/1.0.0/"
  ...
  Scenario: Body of landing page - link two
    ...
    And when body link 2 is clicked, it resolves to "https://fhir.digitalhealth.gov.au/medicare-records/2.2.0/"
  ...
  Scenario: Body of landing page - link three
    ...
    And when body link 3 is clicked, it resolves to "https://fhir.digitalhealth.gov.au/medicare-records/2.1.0/"
